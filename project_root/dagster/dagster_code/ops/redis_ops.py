...
# from ..resources import RedisResourceConfig

# def redis_get(context, redis_key: str, delete: bool, redis: RedisResourceConfig):
...
#         redis_result = {'cache_hit' : True, 'result' : parsed_result}
#     else:
#         redis_result = {'cache_hit' : False, 'result' : None}

#     return redis_result 

# @op(
#     ins={'redis_key' : In(str), 'delete' : In(bool, default_value=False)},
#     out={'cache_hit' : Out(dict, is_required=False), 'cache_miss' : Out(dict, is_required=False)}
# )
# def cache_split(context, redis_key: str, delete: bool, redis: RedisResourceConfig):
#     result = redis_get(context, redis_key, delete, redis)
#     if result['cache_hit']:
#         yield Output(result['result'], 'cache_hit')
#     else:
#         yield Output({}, 'cache_miss')

# @op
# def cache_merge(context, inputs):
#     return inputs[0]
