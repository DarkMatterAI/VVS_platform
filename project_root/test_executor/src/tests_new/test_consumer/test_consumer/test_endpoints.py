import pytest 
from tests_new.utils.request_data import get_plugin_and_request, validate_response
...
async def test_server_endpoint(db_session, rabbitmq_connection, redis_connection, backend_client, plugin_type, batch_size):
